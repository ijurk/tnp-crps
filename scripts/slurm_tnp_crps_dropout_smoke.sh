...
# export TNP_RUN_ID=crps-drop-smoke-${SLURM_JOB_ID}
...
echo "Running CRPS Dropout TNP smoke test..."
...
python -u experiments/lightning_train_crps.py \
  ...
  misc.run_group=crps_tnp_dropout_smoke \
  "$@" \
